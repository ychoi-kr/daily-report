...
INSERT INTO "new_sales_person" ("created_at", "department", "email", "is_manager", "name", "password", "sales_person_id", "updated_at") SELECT "created_at", "department", "email", "is_manager", "name", "password", "sales_person_id", "updated_at" FROM "sales_person";
